...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from her_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in HER_OVERLAYS
        overlay = HER_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify her doctor recognizes Xiaomi env vars."""
