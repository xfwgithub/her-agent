"""Tests for the ``her prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from her_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(her_home, memory_text="", user_text=""):
    mem_dir = her_home / "memories"
...
def _seed_skill(her_home, name, description):
    skill_dir = her_home / "skills" / "demo" / name
