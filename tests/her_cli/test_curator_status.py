"""Tests for `her curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import her_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated HER_HOME with real agent-created skills on disk."""
    home = tmp_path / ".her"
    skills = home / "skills"
    ...
    from her_cli import curator as curator_cli
