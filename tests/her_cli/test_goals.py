"""Tests for her_cli/goals.py — persistent cross-turn goals."""
...
def her_home(tmp_path, monkeypatch):
    """Isolated HER_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves HER_HOME.
    from her_cli import goals
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from her_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from her_cli.goals import judge_goal
...
class TestGoalManager:
    def test_no_goal_initial(self, her_home):
    ...
    def test_set_then_status(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, her_home):
    ...
    def test_evaluate_after_turn_done(self, her_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, her_home):
        from her_cli import goals
        from her_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, her_home):
    ...
    def test_evaluate_after_turn_inactive(self, her_home):
    ...
    def test_continuation_prompt_shape(self, her_home):
        ...
        mgr.set("port goal command to her")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to her" in prompt
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from her_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, her_home):
        """N=3 consecutive parse failures → auto-pause with config pointer."""
        from her_cli import goals
        from her_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, her_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, her_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from her_cli import goals
        from her_cli.goals import GoalManager, load_goal
...
class TestGoalStateSubgoalsBackcompat:
    def test_old_state_meta_row_loads_without_subgoals(self):
        ...
        from her_cli.goals import GoalState
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_add_subgoal_requires_active_goal(self, her_home):
        import pytest
        from her_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, her_home):
        import pytest
        from her_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_remove_subgoal_out_of_range(self, her_home):
        import pytest
        from her_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, her_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, her_home):
        from her_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, her_home):
    ...
    def test_judge_uses_original_template_when_no_subgoals(self, her_home):
        from unittest.mock import patch
        from her_cli import goals
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, her_home):
        from her_cli.goals import GoalManager
    ...
    def test_status_line_with_subgoals(self, her_home):
        from her_cli.goals import GoalManager
