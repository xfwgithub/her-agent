...
import pytest
from her_cli.model_switch import list_authenticated_providers, switch_model
from her_cli import runtime_provider as rp
...
def test_list_authenticated_providers_uses_live_models_for_user_provider(monkeypatch):
    ...
    monkeypatch.setattr("her_cli.models.fetch_api_models", fake_fetch_api_models)
...
def test_switch_model_resolves_user_provider_credentials(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "her_cli.models.validate_requested_model",
...
def _run_user_provider_override_case(
    *,
    ...
    with patch("her_cli.model_switch.resolve_alias", return_value=None), \
         patch("her_cli.model_switch.list_provider_models", return_value=[]), \
         patch("her_cli.model_switch.normalize_model_for_provider", side_effect=lambda model, provider: model), \
         patch("her_cli.models.validate_requested_model", return_value=_REJECTED_VALIDATION), \
         patch("her_cli.models.detect_provider_for_model", return_value=None), \
         patch("her_cli.model_switch.get_model_info", return_value=None), \
         patch("her_cli.model_switch.get_model_capabilities", return_value=None), \
         patch("her_cli.runtime_provider.resolve_runtime_provider", return_value={"api_key": "***", "base_url": base_url, "api_mode": "anthropic_messages"}):
        return switch_model(
            raw_input=raw_input,
