...
The main() function in her_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `her -c model`
...
def _build_parser():
    """Build a minimal replica of the her top-level parser."""
