...
from her_cli.setup import setup_agent_settings
...
def test_setup_agent_settings_uses_displayed_max_iterations_value(tmp_path, monkeypatch, capsys):
    ...
    monkeypatch.setattr("her_cli.setup.save_env_value", lambda *args, **kwargs: None)
    monkeypatch.setattr("her_cli.setup.remove_env_value", lambda *args, **kwargs: None)
    monkeypatch.setattr("her_cli.setup.save_config", lambda *args, **kwargs: None)
...
def test_setup_agent_settings_prefers_config_over_stale_env(tmp_path, monkeypatch, capsys):
    ...
    monkeypatch.setattr(
        "her_cli.setup.remove_env_value",
