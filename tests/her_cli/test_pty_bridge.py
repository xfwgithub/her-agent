"""Unit tests for her_cli.pty_bridge — PTY spawning + byte forwarding.
...
class TestPtyBridgeIO:
    def test_reads_child_stdout(self):
        ...
        try:
            output = _read_until(bridge, b"her-ok")
            assert b"her-ok" in output
        finally:
            bridge.close()
...
class TestClampDimension:
    ...
    def test_floors_at_one(self):
        from her_cli.pty_bridge import _MAX_COLS, _clamp_dimension
