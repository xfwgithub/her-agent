"""Tests for the her-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import her_tools_mcp_server as m
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `her chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.her_tools_mcp_server as m
