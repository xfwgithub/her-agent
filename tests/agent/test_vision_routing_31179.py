...
def isolated_home(monkeypatch):
    """Temp HER_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="her_test_31179_")
    her_home = os.path.join(test_home, ".her")
    os.makedirs(her_home)
...
def _fresh_modules():
    """Drop cached her modules so each test reloads against current env."""
