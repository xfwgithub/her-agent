...
def store(tmp_path, monkeypatch):
    ...
    ~/.her/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at her_state import time, before pytest's HER_HOME monkeypatch
    fires — the autouse fixture's HER_HOME override doesn't help here.)
    """
    import her_state
    monkeypatch.setattr(her_state, "DEFAULT_DB_PATH", tmp_path / "state.db")
