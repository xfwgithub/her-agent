...
def worker_loop(worker_id: int, her_home: str, result_file: str) -> None:
...
def reclaimer_loop(her_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="her_mixed_stress_")
    print(f"HER_HOME = {home}")
