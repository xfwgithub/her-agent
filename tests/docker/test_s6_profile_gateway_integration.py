...
The unit tests in tests/her_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned her-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/her")
from her_cli.service_manager import S6ServiceManager
