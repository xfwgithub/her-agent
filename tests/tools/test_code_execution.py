...
UDS socket lifecycle, her_tools generation, timeout enforcement,
...
class TestherToolsGeneration(unittest.TestCase):
    ...
    def test_generates_subset(self):
        src = generate_her_tools_module(["terminal", "web_search"])
    ...
    def test_non_allowed_tools_ignored(self):
        src = generate_her_tools_module(["vision_analyze", "terminal"])
        self.assertIn("def terminal(", src)
    ...
    def test_uds_transport_serializes_concurrent_calls(self):
        ...
        src = generate_her_tools_module(["terminal"], transport="uds")
...
class TestExecuteCode(unittest.TestCase):
    ...
    def test_repo_root_modules_are_importable(self):
        ...
        result = self._run('import her_constants; print(her_constants.__file__)')
        self.assertEqual(result["status"], "success")
        self.assertIn("her_constants.py", result["output"])
...
"""
    ...
    def test_multi_tool_chain(self):
        ...
        code = """
from her_tools import terminal, read_file
r1 = terminal("ls")
...
"""
        ...
        # terminal won't be in her_tools.py, so import fails
        self.assertEqual(result["status"], "error")
...
"""
    ...
    def test_web_search_tool(self):
        ...
        code = """
from her_tools import web_search
...
"""
    ...
    def test_json_parse_helper(self):
        ...
        code = r"""
from her_tools import json_parse
...
"""
    ...
    def test_shell_quote_helper(self):
        ...
        code = """
from her_tools import shell_quote
...
class TestBuildExecuteCodeSchema(unittest.TestCase):
    ...
    def test_real_scenario_all_sandbox_tools_disabled(self):
        ...
        Scenario: user runs `her tools code_execution` (only code_execution
    ...
    def test_real_scenario_only_vision_enabled(self):
        """Another real path: user runs `her tools code_execution,vision`.
...
class TestExecuteCodeEdgeCases(unittest.TestCase):
    ...
    def test_none_enabled_tools_uses_all(self):
        ...
        code = (
            "from her_tools import terminal, web_search, read_file\n"
    ...
    def test_empty_enabled_tools_uses_all(self):
        ...
        code = (
            "from her_tools import terminal, web_search\n"
            "print('imports ok')\n"
        )
        with patch("model_tools.handle_function_call",
                    return_value=json.dumps({"ok": True})):
...
class TestLoadConfig(unittest.TestCase):
    ...
    def test_returns_code_execution_section(self):
        from tools.code_execution_tool import _load_config
        with patch("her_cli.config.read_raw_config",
    ...
    def test_does_not_import_interactive_cli(self):
        ...
        with patch.dict("sys.modules", {"cli": mock_cli}), \
             patch("her_cli.config.read_raw_config", return_value={}):
            result = _load_config()
