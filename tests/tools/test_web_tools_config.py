...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_her_home_override(self, tmp_path):
        """Auth lookup should read from HER_HOME/auth.json, not ~/.her/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".her").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``her tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
