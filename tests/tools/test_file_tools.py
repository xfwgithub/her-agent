...
class TestSensitivePathCheck:
    ...
    def test_her_config_blocked_for_write_file(self, tmp_path, monkeypatch):
        fake_config = tmp_path / "config.yaml"
        monkeypatch.setattr("tools.file_tools._her_config_resolved", str(fake_config))
        monkeypatch.setattr("tools.file_tools._her_config_resolved_loaded", True)
    ...
    def test_normal_file_not_blocked(self, mock_get, monkeypatch):
        monkeypatch.setattr("tools.file_tools._her_config_resolved", "/home/user/.her/config.yaml")
        monkeypatch.setattr("tools.file_tools._her_config_resolved_loaded", True)
        mock_ops = MagicMock()
        result_obj = MagicMock()
