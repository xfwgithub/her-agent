...
class TestBrowserConsoleToolsetWiring:
    ...
    def test_in_her_core_tools(self):
        from toolsets import _HER_CORE_TOOLS
        assert "browser_console" in _HER_CORE_TOOLS
...
class TestBrowserVisionConfig:
    ...
    def test_browser_vision_uses_configured_temperature_and_timeout(self, tmp_path):
        ...
        with (
            patch("her_constants.get_her_dir", return_value=shots_dir),
            ...
            patch("tools.browser_tool._get_vision_model", return_value="test-model"),
            patch("her_cli.config.load_config", return_value={"auxiliary": {"vision": {"temperature": 1, "timeout": 45}}}),
