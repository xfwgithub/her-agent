...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("her_cli.config.get_config_path", return_value=config_path), \
             patch("her_cli.config.ensure_her_home"):
    ...
    def test_ensure_her_home_sets_0700(self):
        home = Path(self.tmpdir) / ".her"
        with patch("her_cli.config.get_her_home", return_value=home):
