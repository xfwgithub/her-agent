...
Run from the PR worktree:
    ...
    cd ~/.her/her-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.her/her-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.her/her-agent
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a her-agent checkout"
)
...
# Isolated HER_HOME for the config write.
