...
class TestMem0FiltersV2:
    ...
    def test_write_filters_include_agent_id(self):
        ...
        provider._user_id = "u123"
        provider._agent_id = "her"
        assert provider._write_filters() == {"user_id": "u123", "agent_id": "her"}
...
class TestMem0Defaults:
    ...
    def test_default_user_id_her_user(self, monkeypatch, tmp_path):
    ...
    def test_default_agent_id_her(self, monkeypatch, tmp_path):
        monkeypatch.setenv("MEM0_API_KEY", "test-key")
