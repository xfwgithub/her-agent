# nix/web.nix — her Web Dashboard (Vite/React) frontend build
{ pkgs, herNpmLib, ... }:
let
  npm = herNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "her-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../her_cli/web_dist for the
