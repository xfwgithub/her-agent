#!/usr/bin/env python3
"""
SWE Runner with her Trajectory Format

A runner that uses her-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the her-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses her-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in her format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches her-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using her-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with her Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses her-Agent's built-in execution environments
    and outputs trajectories in her-Agent format.
    """
    ...
    def _convert_to_her_format(
        ...
        """
        Convert internal message format to her trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to her trajectory format
        trajectory = self._convert_to_her_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with her trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with her Trajectory Format")
    print("=" * 60)
