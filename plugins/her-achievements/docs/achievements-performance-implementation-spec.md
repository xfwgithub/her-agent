# her Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.her/plugins/her-achievements/state.json` (existing unlock state)
  - `~/.her/plugins/her-achievements/scan_snapshot.json` (new)
  - `~/.her/plugins/her-achievements/scan_checkpoint.json` (new)
