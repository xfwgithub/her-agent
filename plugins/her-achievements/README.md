...
>
> When Hermes is installed via `pip install her-agent` or cloned from source, this plugin auto-registers as a dashboard tab on first `her dashboard` launch. No separate install step. See [Built-in Plugins → her-achievements](../../website/docs/user-guide/features/built-in-plugins.md) in the main docs.
