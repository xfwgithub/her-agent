...
``_check_spotify_available()`` — when the user has not run ``her auth
spotify``, the tools remain registered (so they appear in ``her
...
The Spotify auth flow (``her auth spotify``), CLI plumbing, and docs
