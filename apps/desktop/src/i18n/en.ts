...
export const en: Translations = {
  ...
  boot: {
    ready: 'her Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading her settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingherDesktop: 'Starting her Desktop…'
    },
    errors: {
      backgroundExited: 'her background process exited.',
      backgroundExitedDuringStartup: 'her background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your her backend is older than this desktop build and may not work correctly. Update to align them.',
    updateher: 'Update her',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting her Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to her defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let her follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'her checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading her configuration...',
    ...
    gateway: {
      ...
      intro:
        'her Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running her backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset HER_DESKTOP_REMOTE_URL and HER_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private her backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote her backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /her.',
      ...
      restartingMessage: 'her Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · her ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. her runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure her desktop' },
    ...
    herActiveSessions: (version, count) => `her ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@her:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent her environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. her will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting her...',
    placeholderReconnecting: 'Reconnecting to her…',
    ...
    attachUrlDesc: 'her will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of her can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of her is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed her from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'her will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The her updater will take over in its own window and reopen her when it’s done.',
    applyingClose: 'her will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'her needs a one-time install',
    ...
    settingUpTitle: 'Setting up her Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another her CLI or desktop instance is running. Stop any running her instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The her installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with her Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'her is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting her…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run her',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point her at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — her connects automatically',
      loopback: 'Opens your browser to sign in — her connects automatically',
    ...
    authorizeThere: 'Authorize her there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize her there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'her inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. her will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'her is restarting...',
      askRestart: 'Ask her to restart the server',
      lookingRestart: taskId => `her is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'her is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `her finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'her could not restart the server.',
      stillWorking:
        'her is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'her is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'her gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.her/config.yaml). her won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'her needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'her needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart her Desktop to use Save Image.',
    restartToSaveImages: 'Restart her Desktop to save images',
