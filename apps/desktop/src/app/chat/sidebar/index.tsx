...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/her'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('her:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('her:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
