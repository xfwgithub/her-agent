import type { HerConfigRecord, ToolsetInfo } from '@/types/her'
...
export function getNested(obj: HerConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: HerConfigRecord, path: string, value: unknown): HerConfigRecord {
...
function personalityOptions(config: HerConfigRecord): string[] {
