...
import { getherConfigRecord, type HerGateway, saveherConfig } from '@/her'
...
function getServers(config: HerConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveherConfig(nextConfig)
