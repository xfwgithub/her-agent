...
import type { SessionInfo, UsageStats } from '@/types/her'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'her.desktop.workspace-cwd'
...
export const $connection = atom<HerConnection | null>(null)
...
export const setConnection = (next: Updater<HerConnection | null>) => updateAtom($connection, next)
