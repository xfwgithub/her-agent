 ...
 * product name (`her`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *   '.../release/linux-unpacked/electron' -> '.../release/linux-unpacked/her'
 *
 ...
 * (the mac-unpacked her.app bundle) and Windows (win-unpacked), so we
