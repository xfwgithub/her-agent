...
Data file: $HER_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HER_HOME = Path(os.environ.get("HER_HOME", Path.home() / ".her"))
DATA_DIR = _HER_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
