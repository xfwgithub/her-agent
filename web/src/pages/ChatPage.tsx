/**
 * ChatPage — embeds `her --tui` inside the dashboard.
 *
 ...
 *          ▼                                                              .
 *     FastAPI pty_ws  (her_cli/web_server.py)                          .
 *          ▼                                                              .
  ...
  useEffect(() => {
    ...
    if (useWebgl) {
      try {
        ...
        console.warn(
          "[her-chat] WebGL renderer unavailable; falling back to default",
          err,
        );
      }
    }
    ...
    <div className="flex min-h-0 flex-1 flex-col gap-2">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2 lg:flex-row lg:gap-3">
        ...
        >
          <div
            ref={hostRef}
            className="her-chat-xterm-host min-h-0 min-w-0 flex-1"
          />
