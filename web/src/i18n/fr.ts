...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateher: "Mettre à jour her",
    updatingher: "Mise à jour de her…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins her (parité avec `her plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.her/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.her/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.her/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "her Achievements",
      subtitle:
        "Badges her à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions her en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez her davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'her détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "her analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in her Agent ☤",
    },
  },
  kanban: {
