...
const SIDEBAR_COLLAPSED_KEY = "her-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="her-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="her-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateher,
      runningLabel: t.status.updatingher,
      spin: false,
    },
  ];
