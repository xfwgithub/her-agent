...
Browser-based dashboard for managing her Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “her Agent” — mixed case, no Mondwest, no `text-display` |
