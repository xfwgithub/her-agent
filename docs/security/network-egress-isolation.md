...
When running her inside Docker, the default `network_mode: host` gives the
...
The her [SECURITY.md](../../SECURITY.md) §2 defines the trust model. The
...
- [SECURITY.md](../../SECURITY.md) — her trust model and vulnerability reporting
