# Streaming LLM Response Support for her Agent
...
```
HER_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("HER_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `her_cli/config.py` | 1 | +streaming config defaults |
