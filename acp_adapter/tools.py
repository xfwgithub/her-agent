"""ACP tool-call helpers for mapping her tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map her tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a her tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    *,
    ...
    """Create a ToolCallStart event for the given her tool invocation."""
