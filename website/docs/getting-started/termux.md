...
description: "Run her Agent directly on an Android phone with Termux"
---

# her on Android with Termux

This is the tested path for running her Agent directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop her from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

her now ships a Termux-aware installer path:
