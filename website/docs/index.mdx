...
| 🧭 **[Use MCP with Hermes](/guides/use-mcp-with-her)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Hermes](/guides/use-voice-mode-with-her)** | Hands-on setup and usage patterns for Hermes voice workflows          |
