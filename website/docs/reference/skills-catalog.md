...
| [`her-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-her-agent) | Configure, extend, or contribute to Hermes Agent. | `autonomous-ai-agents/her-agent` |
