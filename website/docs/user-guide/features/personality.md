...
You can also define named custom personalities in `~/.her/config.yaml` under `agent.personalities`.
...
1. Keep a thoughtful global `SOUL.md` in `~/.her/SOUL.md`
...
- [SOUL.md Guide](/guides/use-soul-with-her)
