...
Set your Tenor API key in your environment (add to `~/.her/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/her-agent/blob/main/skills/media/gif-search/url)`
