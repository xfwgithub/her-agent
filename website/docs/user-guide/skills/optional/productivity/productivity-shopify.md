...
| | |
|---|---|
| Source | Optional — install with `her skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"her","productType":"Apparel","tags":["test"]}}'
```
