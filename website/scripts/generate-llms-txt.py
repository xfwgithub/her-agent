#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the her docs site.
...
Both publish at:
  https://her-agent.nousresearch.com/docs/llms.txt
  https://her-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://her-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use her as a Python Library", None),
        ("guides/use-mcp-with-her", "Use MCP with her", None),
        ("guides/use-voice-mode-with-her", "Use Voice Mode with her", None),
        ("guides/use-soul-with-her", "Use SOUL.md with her", None),
        ("guides/build-a-her-plugin", "Build a her Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with her"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "her-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/her-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# her Agent — Full Documentation\n",
        (
            "This file is the entire her Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using her, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://her-agent.nousresearch.com/docs\n",
        "Short index: https://her-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
