...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/use-mcp-with-her", "Use MCP with Hermes", None),
        ("guides/use-voice-mode-with-her", "Use Voice Mode with Hermes", None),
        ("guides/use-soul-with-her", "Use SOUL.md with Hermes", None),
        ("guides/build-a-her-plugin", "Build a Hermes Plugin", None),
