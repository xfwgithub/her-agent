...
DEFAULT_DATASETS = [
    ...
    "NousResearch/her-agent-megascience-sft1",
    "NousResearch/her-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/her-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-her-agent"
]
