...
def _profile_user_agent() -> str:
    """Return a ``her-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from her_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"her-cli/{_ver}"
    except Exception:
        return "her-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # her-cli UA so the catalog endpoint is reachable.
