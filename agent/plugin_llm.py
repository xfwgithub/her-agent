...
Plugins built on her Agent often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing her
...
embedded slugs, no shorthands. This mirrors her' main config
...
handles every provider, fallback chain, and per-task override her
supports.
"""
