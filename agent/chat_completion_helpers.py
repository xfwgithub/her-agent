...
from her_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from her_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
...
def build_api_kwargs(agent, api_messages: list) -> dict:
    ...
    if _is_qwen:
        _qwen_meta = {
            "sessionId": agent.session_id or "her",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in her_cli/config.py).
