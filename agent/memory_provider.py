...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - her_home (str): The active HER_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.her``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "her").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'her memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], her_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'her memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``her_home`` is the active HER_HOME directory path.
