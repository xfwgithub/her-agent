...
Trust levels:
  - builtin:   Ships with her. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.her/\.env|\~/\.her/\.env',
     "her_env_access", "critical", "exfiltration",
     "directly references her secrets file"),
    ...
    (r'\.her/config\.yaml|\.her/SOUL\.md',
     "her_config_mod", "critical", "persistence",
     "references her configuration files directly"),
...
# scan. `.skillignore` is the her-native name; `.clawhubignore` is honored
