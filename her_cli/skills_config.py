"""
Skills configuration for her Agent.
`her skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.her/config.yaml under:
...
from her_cli.config import cfg_get, load_config, save_config
