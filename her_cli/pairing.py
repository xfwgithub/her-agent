...
Usage:
    her pairing list              # Show all pending + approved users
    her pairing approve <platform> <code>  # Approve a pairing code
    her pairing revoke <platform> <user_id> # Revoke user access
    her pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle her pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: her pairing {list|approve|revoke|clear-pending}")
        print("Run 'her pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.her/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'her pairing list' to see pending codes.\n")
