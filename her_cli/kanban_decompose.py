...
Invoked by ``her kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the her Agent board.
...
def _profile_author() -> str:
    """Mirror of ``her_cli.kanban._profile_author``."""
    return (
        os.environ.get("HER_PROFILE")
