...
Used by ``her profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``her_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the her Agent kanban board.
...
Rules:
  ...
  - Never write "her Agent profile" or other meta-narration.
