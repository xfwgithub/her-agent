...
Used by ``her kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``her_cli/goals.py`` — same aux
...
def _profile_author() -> str:
    """Mirror of ``her_cli.kanban._profile_author``. Kept local to
